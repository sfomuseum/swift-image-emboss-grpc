...
public struct ImageEmbosser_EmbossImageRequest: @unchecked Sendable {
...
public struct ImageEmbosser_EmbossImageResponse: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
fileprivate let _protobuf_package = "image_embosser"

extension ImageEmbosser_EmbossImageRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: ImageEmbosser_EmbossImageRequest, rhs: ImageEmbosser_EmbossImageRequest) -> Bool {
...
extension ImageEmbosser_EmbossImageResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: ImageEmbosser_EmbossImageResponse, rhs: ImageEmbosser_EmbossImageResponse) -> Bool {
    if lhs.filename != rhs.filename {return false}
    if lhs.body != rhs.body {return false}
    if lhs.combined != rhs.combined {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
